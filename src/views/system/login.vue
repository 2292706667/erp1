<template>
	<div class="login-wrap">
		<el-form class="login-container">
			<h1 calss="title">用戶登錄</h1>
			<el-form-item><el-input type="text" placeholder="請輸入賬號" v-model="username" autocomplete="off"></el-input></el-form-item>
			<el-form-item><el-input type="password" placeholder="請輸入密碼" v-model="userpwd" autocomplete="off"></el-input></el-form-item>
			<el-form-item>
				<el-button type="primary" @click="dologin" style="width: 48%;">登錄</el-button>
				<el-button type="primary" @click="dozc" style="width: 48%;">注册</el-button>
			</el-form-item>
			<el-link type="info">忘記密碼</el-link>
			<el-link type="info">關於我們</el-link>
		</el-form>
		<!-- <router-link to="/Userzc" tag="span">注冊賬號</router-link>
	...
	methods: {
		dozc() {
			let param={
				...
				usrPassword:this.userpwd,
			}
			
			this.$router.push(
			// '/zc/參數值'
			{name:'zc',params:param}
			// {path:'/zc',query:param}
			);
		},
		...
		dologin() {
			...
			this.axios
				...
				.then(response => {
					this.$store.commit('setnodelist',{nodelist:response.data.data.list})	
			...
			// 			this.axios.post(url,parem).then(response=>{
